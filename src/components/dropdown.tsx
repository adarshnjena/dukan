  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button className="text-white flex w-full m-0 justify-between items-center">
          <div className="flex flex-col items-start">
            <p className="text-[15px] font-medium">Nishyan</p>
            <p className="text-[13px] font-normal opacity-[0.8] underline mt-1">
              Visit store
            </p>
          </div>
          <div className="ml-2">
      ...
      <DropdownMenuContent className="w-56 bg-black/80 border-none rounded-[10px]">
